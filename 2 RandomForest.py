...
param_distribute={'n_estimators':np.arange(0, 1500, 200),'criterion':["gini","entropy"],'max_depth':np.arange(0, 1000,100),'min_samples_leaf':range(1,20),
'min_samples_split':range(1, 20),'max_features':['auto', 'sqrt', 'log2']}
...
import joblib
joblib.dump(clf,'RF.pkl',compress=3)