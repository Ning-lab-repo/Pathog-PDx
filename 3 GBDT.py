...
param_distribute={'learning_rate':np.arange(0.1,1,0.1),'max_iter':[50,100,500,1000,1500,2000],'loss':['log_loss', 'exponential'],'max_depth':np.arange(0,100,10),'min_samples_leaf':range(1,20)
             ,'max_features':np.arange(0.1,1,0.1),'max_leaf_nodes':[1,10,20,31,40,50,100]}
...
import joblib
joblib.dump(clf,'GBDT.pkl',compress=3)