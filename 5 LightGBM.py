...
clf=LGBMClassifier()
param_distribute={'learning_rate':np.arange(0,1,0.1), 'num_leaves':[10,20,31,40],'n_estimators':[50,100,500,1000,1500,2000],'min_split_gain':[0,5,10,15,20],'max_depth':[-1,5,8,10,25,20]
             ,'min_child_samples':[5,10,20,25,30],'n_jobs':[24]}
...
import joblib
joblib.dump(clf,'light.pkl',compress=3)